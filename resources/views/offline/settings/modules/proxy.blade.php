...
<div class="module-container" id="module_settings_proxy">
    <div class="module-header">
        <div class="module-title">{{ ucfirst(trans('settings.proxy.title')) }}</div>
    </div>
    <div class="module-bar info-bar">
        <div class="icon">{!! Template::icon('info-circle', '', '1.4em') !!}</div>
        <div class="message">@lang('settings.proxy.info')</div>
    </div>
    <div class="module-body p-2">
        ...
        @foreach(['proxy_host', 'proxy_port', 'proxy_user'] as $field)
            @component('modular-forms::module.components.field_container', [
                'name' => $field,
                'label' => ucfirst(trans('settings.proxy.fields.'.$field)),
                'label_width' => 2
            ])
        ...
        @component('modular-forms::module.components.field_container', [
            'name' => 'proxy_password',
            'label' => ucfirst(trans('settings.proxy.fields.proxy_password')),
            'label_width' => 2
        ])
