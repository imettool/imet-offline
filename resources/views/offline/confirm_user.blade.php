        ...
        <div id="module_person__confirm_offline" class="module-container">
            ...
            <div class="module-body">
                ...
                @component('modular-forms::module.components.field_container', [
                    ...
                    <input id="first_name" type="text" class="field-edit" name="first_name"
                           value="{{ $item->first_name }}" required autofocus>
                @endcomponent
                ...
                @component('modular-forms::module.components.field_container', [
                    ...
                    <input id="last_name" type="text" class="field-edit" name="last_name" value="{{ $item->last_name }}"
                           required autofocus>
                @endcomponent
                ...
                @component('modular-forms::module.components.field_container', [
                    ...
                    <input id="organisation" type="text" class="field-edit" name="organisation"
                           value="{{ $item->organisation }}" required autofocus>
                @endcomponent
                ...
                @component('modular-forms::module.components.field_container', [
                    ...
                    <input id="function" type="text" class="field-edit" name="function" value="{{ $item->function }}"
                           required autofocus>
                @endcomponent
