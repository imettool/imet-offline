...
return [
    ...
    'proxy' => [
        'title' => 'Proxy',
        'info' => 'Nécessaire uniquement si votre PC se trouve derrière un serveur proxy.',
        'fields' => [
            'proxy_host' => 'Hôte',
            'proxy_port' => 'Port',
    ...
    'wdpas' => [
        'info' => "Avec la procédure suivante, il est possible de mettre à jour <b>la Base de données mondiale sur les
